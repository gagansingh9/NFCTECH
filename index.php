  ...
  <img src="images/logo.png" id="logo">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        <li class="nav-item">
          <a class="nav-link active" aria-current="page" href="../app/PagPromo/quienessomos.html ">Sobre Nosotros</a>
        </li>
...
if ($hora < 12) {
  echo "<h1 style='font-size: 30px;'  >BUENOS DIAS</h1>";
} else if ($hora < 20) {
  echo "<h1  style='font-size: 30px;' >BUENAS TARDES</h1>";
} else {
  echo "<h1 style='font-size: 30px;'  >BUENAS NOCHES</h1>";
}
